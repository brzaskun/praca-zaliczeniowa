...
//        }
     ...
     public void dodajNowyWpis(SrodekTrw selectedSTR){
        try {
            ...
            FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_INFO,"Nowy strument zachowany", selectedSTR.getNazwa().toString());
            FacesContext.getCurrentInstance().addMessage(null, msg);
        } catch (Exception e) {
            System.out.println("Nie utworzono srodka "+e.toString());
            FacesMessage msg = new FacesMessage(FacesMessage.SEVERITY_ERROR,"SrodekTrwument nie uwtorzony DAO"+e.toString(),"");
            FacesContext.getCurrentInstance().addMessage(null, msg);
