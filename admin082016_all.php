...
<html lang="pl">
    ...
    <head>
        ...
        <script src="/resources/dataTableNew/media/js/dataTables.jqueryui.js?v180817c" type="text/javascript"></script>
        ...
        <script src="resources/js/common_generowanietabeli.js?v180817c" type="text/javascript"></script>
        <script src="/resources/js/admin082016_all.js?v180817c"></script>
