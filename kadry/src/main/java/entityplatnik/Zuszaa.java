...
@XmlRootElement
@NamedQueries({
    @NamedQuery(name = "Zuszaa.findAll", query = "SELECT z FROM Zuszaa z"),
    @NamedQuery(name = "Zuszaa.findByIdDokument", query = "SELECT z FROM Zuszaa z WHERE z.idDokument = :idDokument"),
    @NamedQuery(name = "Zuszaa.findByIdPlatnik", query = "SELECT z FROM Zuszaa z WHERE z.idPlatnik = :idPlatnik"),
    @NamedQuery(name = "Zuszaa.findByI1Datanadania", query = "SELECT z FROM Zuszaa z WHERE z.i1Datanadania = :i1Datanadania"),
    @NamedQuery(name = "Zuszaa.findByI2Nalepkar", query = "SELECT z FROM Zuszaa z WHERE z.i2Nalepkar = :i2Nalepkar"),
    @NamedQuery(name = "Zuszaa.findByIi1Nip", query = "SELECT z FROM Zuszaa z WHERE z.ii1Nip = :ii1Nip"),
    @NamedQuery(name = "Zuszaa.findByIi2Regon", query = "SELECT z FROM Zuszaa z WHERE z.ii2Regon = :ii2Regon"),
    @NamedQuery(name = "Zuszaa.findByIi3Pesel", query = "SELECT z FROM Zuszaa z WHERE z.ii3Pesel = :ii3Pesel"),
    @NamedQuery(name = "Zuszaa.findByIi4Rodzdok", query = "SELECT z FROM Zuszaa z WHERE z.ii4Rodzdok = :ii4Rodzdok"),
    @NamedQuery(name = "Zuszaa.findByIi5Serianrdok", query = "SELECT z FROM Zuszaa z WHERE z.ii5Serianrdok = :ii5Serianrdok"),
    @NamedQuery(name = "Zuszaa.findByIi6Nazwaskr", query = "SELECT z FROM Zuszaa z WHERE z.ii6Nazwaskr = :ii6Nazwaskr"),
    @NamedQuery(name = "Zuszaa.findByIi7Nazwisko", query = "SELECT z FROM Zuszaa z WHERE z.ii7Nazwisko = :ii7Nazwisko"),
    @NamedQuery(name = "Zuszaa.findByIi8Imiepierw", query = "SELECT z FROM Zuszaa z WHERE z.ii8Imiepierw = :ii8Imiepierw"),
    @NamedQuery(name = "Zuszaa.findByIi9Dataurodz", query = "SELECT z FROM Zuszaa z WHERE z.ii9Dataurodz = :ii9Dataurodz"),
    @NamedQuery(name = "Zuszaa.findByIx1Datawypel", query = "SELECT z FROM Zuszaa z WHERE z.ix1Datawypel = :ix1Datawypel"),
    @NamedQuery(name = "Zuszaa.findByStatuswr", query = "SELECT z FROM Zuszaa z WHERE z.statuswr = :statuswr"),
    @NamedQuery(name = "Zuszaa.findByStatuspt", query = "SELECT z FROM Zuszaa z WHERE z.statuspt = :statuspt"),
    @NamedQuery(name = "Zuszaa.findByInserttmp", query = "SELECT z FROM Zuszaa z WHERE z.inserttmp = :inserttmp"),
    @NamedQuery(name = "Zuszaa.findBySeria", query = "SELECT z FROM Zuszaa z WHERE z.seria = :seria"),
    @NamedQuery(name = "Zuszaa.findByLPozycji", query = "SELECT z FROM Zuszaa z WHERE z.lPozycji = :lPozycji"),
    @NamedQuery(name = "Zuszaa.findByStatuszus", query = "SELECT z FROM Zuszaa z WHERE z.statuszus = :statuszus"),
    @NamedQuery(name = "Zuszaa.findByStatusKontroli", query = "SELECT z FROM Zuszaa z WHERE z.statusKontroli = :statusKontroli"),
    @NamedQuery(name = "Zuszaa.findByIdPlZusStatus", query = "SELECT z FROM Zuszaa z WHERE z.idPlZusStatus = :idPlZusStatus")})
public class Zuszaa implements Serializable {
    ...
    public Zuszaa(Integer idDokument) {
        this.idDokument = idDokument;
    }

    public Zuszaa(Integer idDokument, int idPlatnik) {
        this.idDokument = idDokument;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof Zuszaa)) {
            return false;
        }
        Zuszaa other = (Zuszaa) object;
    ...
    public String toString() {
        return "entityplatnik.Zuszaa[ idDokument=" + idDokument + " ]";
    }
