...
public class DefinicjalistaplacController implements Serializable {
    ...
    @EJB
    private tmp.DefinicjalistaplacFacade ejbFacade;
    ...
    private DefinicjalistaplacFacade getFacade() {
        return ejbFacade;
    }
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/Bundle").getString("DefinicjalistaplacCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/Bundle").getString("DefinicjalistaplacUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/Bundle").getString("DefinicjalistaplacDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public Definicjalistaplac getDefinicjalistaplac(java.lang.Integer id) {
