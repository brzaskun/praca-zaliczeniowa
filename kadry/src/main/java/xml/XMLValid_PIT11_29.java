 ...
 * @author Osito
 */
public class XMLValid_PIT11_29 {
    
    private static String schemaPIT1129 = "resources\\xsd\\pit1129.xsd";
    
    public static Object[] walidujPIT1129(String mainfilename) {
            Object[] zwrot = new Object[2];
            zwrot[0] = Boolean.FALSE;
            error.E.s("start walidacji");
            ServletContext ctx = (ServletContext) FacesContext.getCurrentInstance().getExternalContext().getContext();
            String realPath = ctx.getRealPath("/")+schemaPIT1129;
            try {
