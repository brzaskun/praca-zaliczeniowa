...
@Stateless
@Transactional
public class NieobecnoscswiadectwoschemaFacade extends DAO  implements Serializable {
    ...
    public NieobecnoscswiadectwoschemaFacade() {
        super(Nieobecnoscswiadectwoschema.class);
        super.em = em;
    }
