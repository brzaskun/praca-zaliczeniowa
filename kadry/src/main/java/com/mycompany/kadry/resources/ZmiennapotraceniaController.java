...
public class ZmiennapotraceniaController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/messagesbundle/Bundle").getString("ZmiennapotraceniaCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/messagesbundle/Bundle").getString("ZmiennapotraceniaUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/messagesbundle/Bundle").getString("ZmiennapotraceniaDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Zmiennapotracenia> getItems() {
        if (items == null) {
            items = getFacade().findAll(Zmiennapotracenia.class);
        }
        return items;
    }
    ...
    public Zmiennapotracenia getZmiennapotracenia(java.lang.Integer id) {
        return (Zmiennapotracenia) getFacade().findEntity(Zmiennapotracenia.class, id);
    }

    public List<Zmiennapotracenia> getItemsAvailableSelectMany() {
        return getFacade().findAll(Zmiennapotracenia.class);
    }
