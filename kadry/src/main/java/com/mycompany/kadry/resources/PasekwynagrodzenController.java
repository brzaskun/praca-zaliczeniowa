...
public class PasekwynagrodzenController implements Serializable {
    ...
    public void create() {
        persist(PersistAction.CREATE, ResourceBundle.getBundle("/messagesbundle/Bundle").getString("PasekwynagrodzenCreated"));
    ...
    public void update() {
        persist(PersistAction.UPDATE, ResourceBundle.getBundle("/messagesbundle/Bundle").getString("PasekwynagrodzenUpdated"));
    }

    public void destroy() {
        persist(PersistAction.DELETE, ResourceBundle.getBundle("/messagesbundle/Bundle").getString("PasekwynagrodzenDeleted"));
        if (!JsfUtil.isValidationFailed()) {
    ...
    public List<Pasekwynagrodzen> getItems() {
        if (items == null) {
            items = getFacade().findAll(Pasekwynagrodzen.class);
        }
        return items;
    }
    ...
    public Pasekwynagrodzen getPasekwynagrodzen(java.lang.Integer id) {
        return (Pasekwynagrodzen) getFacade().findEntity(PasekwynagrodzenController.class, id);
    }

    public List<Pasekwynagrodzen> getItemsAvailableSelectMany() {
        return getFacade().findAll(Pasekwynagrodzen.class);
    }
