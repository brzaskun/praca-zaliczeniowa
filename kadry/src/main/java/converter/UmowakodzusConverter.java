...
@Named
@SessionScoped
public class UmowakodzusConverter implements javax.faces.convert.Converter, Serializable {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return String.valueOf(((Umowakodzus) value).getId());
        }
    }
}
