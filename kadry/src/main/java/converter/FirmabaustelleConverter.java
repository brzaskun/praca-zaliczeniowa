...
@Named
@ViewScoped
public class FirmabaustelleConverter implements javax.faces.convert.Converter, Serializable {
    ...
    @PostConstruct
    private void init() {
        lista = firmabaustelleFacade.findAll();
    }
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return String.valueOf(((Firmabaustelle) value).getId());
        }
    }
