...
@Named
@ViewScoped
public class FakturaopisuslugiConverter implements javax.faces.convert.Converter, Serializable {
    ...
    public String getAsString(FacesContext facesContext, UIComponent component, Object value) {
        if (value == null || value.equals("")) {
            ...
            return String.valueOf(((Fakturaopisuslugi) value).getId());
        }
    }
}
