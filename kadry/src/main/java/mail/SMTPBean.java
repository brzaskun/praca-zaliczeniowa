...
public class SMTPBean {
    ...
    public static SMTPSettings pobierzSMTP(SMTPSettingsFacade sMTPSettingsDAO, Uz uzytkownik) {
    ...
    public static SMTPSettings pobierzSMTPDef(SMTPSettingsFacade sMTPSettingsDAO) {
        SMTPSettings zwrot = null;
        try {
