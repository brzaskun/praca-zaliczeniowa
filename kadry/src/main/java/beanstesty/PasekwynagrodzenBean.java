...
//        KalendarzmiesiacBean.naliczskladnikipotraceniaDB(kalendarz, pasek);
    ...
    public static Pasekwynagrodzen obliczWynagrodzenie(Kalendarzmiesiac kalendarz, Definicjalistaplac definicjalistaplac, SwiadczeniekodzusFacade nieobecnosckodzusFacade, List<Pasekwynagrodzen> paskidowyliczeniapodstawy,
        ...
        if (pasek.isFunkcja()) {
            ...
            PasekwynagrodzenBean.emerytalnaNo(pasek);
            PasekwynagrodzenBean.rentowaNo(pasek);
            PasekwynagrodzenBean.wypadkowaNo(pasek);
            PasekwynagrodzenBean.razemspolecznefirma(pasek);
...
//        }
    ...
    private static void umowaswiadczenierzeczowewyliczenie(Kalendarzmiesiac kalendarz, Kalendarzwzor kalendarzglobalny, Pasekwynagrodzen pasek, double kurs, Definicjalistaplac definicjalistaplac,
        ...
        if (kalendarz.getAngaz().jestumowaPracaAktywna(kalendarz.getRok(), kalendarz.getMc())) {
            ...
            KalendarzmiesiacBean.naliczskladnikiwynagrodzeniaDB(kalendarz, pasek, kurs, wynagrodzenieminimalne.getKwotabrutto(), kalendarzglobalny);
            PasekwynagrodzenBean.obliczbruttoumowazlecenia(pasek, null, limit26, sumabruttopoprzednich, sumabruttoopodatkowanapoprzednich);
            PasekwynagrodzenBean.wyliczpodstaweZUS(pasek);
            PasekwynagrodzenBean.pracownikemerytalna(pasek);
            PasekwynagrodzenBean.pracownikrentowa(pasek);
            //bierze chorobowa z aktualnej umowy
            PasekwynagrodzenBean.pracownikchorobowaZlecenie(pasek, null);
            PasekwynagrodzenBean.razemspolecznepracownik(pasek);
            PasekwynagrodzenBean.obliczbruttominusspoleczneDB(pasek);
            PasekwynagrodzenBean.obliczpodstaweopodatkowaniaZlecenie(pasek, stawkipodatkowe, pasek.isNierezydent());
            PasekwynagrodzenBean.obliczpodatekwstepnyZlecenieDB(pasek, stawkipodatkowe, pasek.isNierezydent());
...
//        PasekwynagrodzenBean.obliczbruttobezSpolecznych(pasek);
        PasekwynagrodzenBean.wyliczpodstaweZUS(pasek);
        PasekwynagrodzenBean.pracownikemerytalnaNo(pasek);
        PasekwynagrodzenBean.pracownikrentowaNo(pasek);
        PasekwynagrodzenBean.pracownikchorobowaNo(pasek);
        PasekwynagrodzenBean.razemspolecznepracownik(pasek);
        PasekwynagrodzenBean.obliczbruttominusspoleczneDB(pasek);
...
//        PasekwynagrodzenBean.obliczpodatekwstepnyZlecenieDB(pasek, stawkipodatkowe, pasek.isNierezydent());
    ...
    //            if (p.isZus0bezzus1() == false && p.isPodatek0bezpodatek1() == false) {
                ...
                if (p.getSkladnikwynagrodzenia().getRodzajwynagrodzenia().isSkladkarentowa()) {
                        przychodyzus51rentowa = przychodyzus51rentowa + p.getKwotadolistyplac();
                }
                if (p.getSkladnikwynagrodzenia().getRodzajwynagrodzenia().isSkladkachorobowa()) {
                        przychodyzus51chorobowa = przychodyzus51chorobowa + p.getKwotadolistyplac();
                }
                if (p.getSkladnikwynagrodzenia().getRodzajwynagrodzenia().isSkladkawypadkowa()) {
                        przychodyzus51wypadkowa = przychodyzus51wypadkowa + p.getKwotadolistyplac();
                }
                ...
                if (p.getSkladnikwynagrodzenia().getRodzajwynagrodzenia().isSkladkapodatek()) {
                    if (p.getSkladnikwynagrodzenia().getRodzajwynagrodzenia()!=null&&p.getSkladnikwynagrodzenia().getRodzajwynagrodzenia().getKod()!=null&&p.getSkladnikwynagrodzenia().getRodzajwynagrodzenia().getKod().equals("13")) {
    ...
    //            taki krzywy ryj bo nie ma oznaczenia oddelegowanie przy nieobecnosci urlop delehowanie
                ...
                if (p.getNieobecnosc().getRodzajnieobecnosci().isNieskladkowy()==false) {
                    ...
                    przychodyzus51chorobowa = przychodyzus51chorobowa + p.getKwotazus();
                    przychodyzus51wypadkowa = przychodyzus51wypadkowa + p.getKwotazus();
        ...
        zwrot.setPrzychodyzus51emerytalna(przychodyzus51emerytalna);
    ...
    private static void obliczbruttoumowafunkcja(Pasekwynagrodzen pasek) {
        ...
        pasek.setPodstawaskladkizusrentowa(sumyprzychodow.przychodyzus51rentowa);
        pasek.setPodstawaskladkizuschorobowa(sumyprzychodow.przychodyzus51chorobowa);
        pasek.setPodstawaskladkizuswypadkowa(sumyprzychodow.przychodyzus51wypadkowa);
        pasek.setPrzychodypodatekpolska(przychodyBiezacyMiesiacPolska);
        pasek.setPrzychodypodatekzagranica(przychodyBiezacyMiesiacZagranica);
        pasek.setBruttozuskraj(sumyprzychodow.getBruttokraj());
        pasek.setBruttobezzusbezpodatek(sumyprzychodow.bezzusbezpodatek);
    ...
    private static void obliczbruttoumowazlecenia(Pasekwynagrodzen pasek, Rachunekdoumowyzlecenia rachunekdoumowyzlecenia, double limit26, double sumapoprzednich, double sumabruttoopodatkowanapoprzednich) {
        ...
        double doopodatkowaniapow26narast = przychodynarastajacodolimitu26 - limit26;
        pasek.setPrzekroczenie26lat(doopodatkowaniapow26narast);
        boolean statusstudenta = rachunekdoumowyzlecenia!=null?rachunekdoumowyzlecenia.isStatusstudenta():false;
        boolean innytytul = rachunekdoumowyzlecenia!=null?rachunekdoumowyzlecenia.isInnytytulminim():false;
        if (pasek.isDo26lat() && statusstudenta) {
            pasek.setPrzychodyzus51(0.0);
            pasek.setPrzychodyzus52(0.0);
            pasek.setPrzychodypodatekpolska(0.0);
           if (doopodatkowaniapow26narast > 0.0) {
        ...
        }else if (pasek.isDo26lat() && statusstudenta==false) {
            pasek.setPrzychodypodatekpolska(0.0);
            pasek.setPrzychodypodatekpolska(0.0);
            if (doopodatkowaniapow26narast > 0.0) {
               double doopodatkowaniaZaMiesiac = doopodatkowaniapow26narast-sumabruttoopodatkowanapoprzednich;
        ...
        pasek.setStudent(statusstudenta);
        pasek.setOddelegowaniepln(sumyprzychodow.getBruttooddelegowanie());
        pasek.setOddelegowaniewaluta(sumyprzychodow.getBruttooddelegowaniewaluta());
        pasek.setBruttozuskraj(sumyprzychodow.getBruttokraj());
...
//    }
    ...
    private static void emerytalnaNo(Pasekwynagrodzen pasek) {
        pasek.setEmerytalne(Z.z(pasek.getPodstawaskladkizusemerytalna() * 0.0976));
    }
    ...
    private static void pracownikrentowaNo(Pasekwynagrodzen pasek) {
        pasek.setPracrentowe(Z.z(pasek.getPodstawaskladkizusrentowa() * 0.015));
    }
    ...
    private static void pracownikchorobowaNo(Pasekwynagrodzen pasek) {
        pasek.setPracchorobowe(Z.z(pasek.getPodstawaskladkizuschorobowa() * 0.0245));
    }

    private static void pracownikchorobowaZlecenie(Pasekwynagrodzen pasek, Rachunekdoumowyzlecenia rachunekdoumowyzlecenia) {
        boolean chorobowa = rachunekdoumowyzlecenia!=null?rachunekdoumowyzlecenia.isChorobowa():pasek.getAngaz().getAktywnaUmowa().isChorobowedobrowolne();
        if (chorobowa) {
            pasek.setPracchorobowe(Z.z(pasek.getPodstawaskladkizus() * 0.0245));
        }
    }
    ...
    private static void wypadkowa(Pasekwynagrodzen pasek) {
      ...
      private static void wypadkowaNo(Pasekwynagrodzen pasek) {
        List<Wypadkowefirma> wypadkowefirmaList = pasek.getKalendarzmiesiac().getAngaz().getFirma().getWypadkowefirmaList();
        Wypadkowefirma pobrane = null;
        if (wypadkowefirmaList != null) {
            for (Wypadkowefirma w : wypadkowefirmaList) {
        ...
        if (pobrane == null) {
            pasek.setWypadkowe(Z.z(pasek.getPodstawaskladkizuswypadkowa() * 0.0167));
        } else {
            pasek.setWypadkowe(Z.z(pasek.getPodstawaskladkizuswypadkowa() * (pobrane.getProcent() / 100.0)));
        }
...
//        double bezspolecznych = pasek.getBruttobezspolecznych();
    ...
    private static void obliczpodstaweopodatkowaniaDB(Pasekwynagrodzen pasek, List<Podatki> stawkipodatkowe, boolean nieodliczackup, boolean podwyzszonekoszty) {
        ...
        double juzodliczonekoszty = czyodliczonojuzkup(pasek);
        kosztyuzyskania = Z.z(kosztyuzyskania-juzodliczonekoszty)>0.0?Z.z(kosztyuzyskania-juzodliczonekoszty):0.0;
...
//        }
    ...
    private static void obliczpodstaweopodatkowaniaZlecenie(Pasekwynagrodzen pasek, List<Podatki> stawkipodatkowe, boolean nierezydent) {
        ...
        double procentkosztyuzyskania = rachunekdoumowyzlecenia!=null?rachunekdoumowyzlecenia.getProcentkosztowuzyskania():20.0;
...
//    }
    ...
    private static void ulgapodatkowa(Pasekwynagrodzen pasek, boolean ulga) {
        ...
        double iloscodliczonanainnychlistach = czyodliczonojuzkwotewolna(pasek);
        kwotawolna = Z.z(kwotawolna-iloscodliczonanainnychlistach)>0.0?Z.z(kwotawolna-iloscodliczonanainnychlistach):0.0;
...
//                }
    ...
    private static double czyodliczonojuzkwotewolna(Pasekwynagrodzen pasek) {
        double juzodliczono  = 0.0;
        List<Pasekwynagrodzen> pasekwynagrodzenList = pasek.getKalendarzmiesiac().getPasekwynagrodzenList();
        if (pasekwynagrodzenList.isEmpty()==false) {
            for (Pasekwynagrodzen pas : pasekwynagrodzenList) {
                if (pasek.equals(pas)==false) {
                    juzodliczono = juzodliczono+pas.getKwotawolna();
                }
            }
        }
        return juzodliczono;
    ...
    private static double czyodliczonojuzkup(Pasekwynagrodzen pasek) {
        double juzodliczono  = 0.0;
        List<Pasekwynagrodzen> pasekwynagrodzenList = pasek.getKalendarzmiesiac().getPasekwynagrodzenList();
        if (pasekwynagrodzenList.isEmpty()==false) {
            for (Pasekwynagrodzen pas : pasekwynagrodzenList) {
                if (pasek.equals(pas)==false) {
                    juzodliczono = juzodliczono+pas.getKosztyuzyskania();
                }
            }
        }
        return juzodliczono;
