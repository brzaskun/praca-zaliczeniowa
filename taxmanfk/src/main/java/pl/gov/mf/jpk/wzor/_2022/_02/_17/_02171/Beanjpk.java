...
public class Beanjpk {
    ...
    public static Dok generujdok(Object p, String waldok, List<Evewidencja> evewidencje, TabelanbpDAO tabelanbpDAO, Tabelanbp tabeladomyslna, List<Klienci> klienci, boolean wybierzosobyfizyczne, 
        ...
        pl.gov.mf.jpk.wzor._2022._02._17._02171.JPK.Faktura faktura = (pl.gov.mf.jpk.wzor._2022._02._17._02171.JPK.Faktura) p;
    ...
    private static void ustawwiersze(Dokfk nd, Rodzajedok rodzajedok,pl.gov.mf.jpk.wzor._2022._02._17._02171.JPK.Faktura faktura, Tabelanbp tabelanbppl, TabelanbpDAO tabelanbpDAO, KliencifkDAO kliencifkDAO, WpisView wpisView, 
     ...
     private static Wiersz przygotujwierszNettoSprzedaz(int lpwiersza,Dokfk nd, pl.gov.mf.jpk.wzor._2022._02._17._02171.JPK.Faktura faktura, Konto kontown, Konto kontoma, Tabelanbp tabelanbppl, TabelanbpDAO tabelanbpDAO) {
     ...
     private static Wiersz przygotujwierszVATNalezny(int lpwiersza,Dokfk nd, pl.gov.mf.jpk.wzor._2022._02._17._02171.JPK.Faktura faktura, Konto kontown, Konto kontoma, Tabelanbp tabelanbppl, TabelanbpDAO tabelanbpDAO) {
     ...
     private static void uzupelnijwiersz(Wiersz w, Dokfk nd, pl.gov.mf.jpk.wzor._2022._02._17._02171.JPK.Faktura faktura, Tabelanbp tabelanbppl, TabelanbpDAO tabelanbpDAO, int lpmacierzystego) {
    ...
    private static Klienci pobierzkontrahenta(pl.gov.mf.jpk.wzor._2022._02._17._02171.JPK.Faktura faktura, String nrKontrahenta, List<Klienci> klienci, boolean wybierzosobyfizyczne, boolean deklaracjaniemiecka, KlienciDAO klDAO) {
    ...
    private static Evewidencja pobierzewidencje(pl.gov.mf.jpk.wzor._2022._02._17._02171.JPK.Faktura faktura, List<Evewidencja> evewidencje) {
    ...
    private static double obliczstawke(pl.gov.mf.jpk.wzor._2022._02._17._02171.JPK.Faktura faktura) {
        double stawka = 23;
