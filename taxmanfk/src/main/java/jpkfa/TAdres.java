...
@XmlSeeAlso({
    jpkfa.TPodmiotDowolny.AdresZamieszkaniaSiedziby.class,
    jpkfa.TOsobaFizyczna1 .AdresZamieszkania.class,
    jpkfa.TOsobaNiefizyczna.AdresSiedziby.class,
    jpkfa.TOsobaFizyczna2 .AdresZamieszkania.class,
    jpkfa.TOsobaNiefizycznaPelna.AdresSiedziby.class,
    jpkfa.TOsobaFizyczna.AdresZamieszkania.class,
    jpkfa.TPodmiotDowolnyPelny.AdresZamieszkaniaSiedziby.class,
    jpkfa.TOsobaFizycznaPelna.AdresZamieszkania.class
})
public class TAdres {
