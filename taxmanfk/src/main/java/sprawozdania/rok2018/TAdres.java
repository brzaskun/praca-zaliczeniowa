...
@XmlType(name = "TAdres", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2016/01/25/eD/DefinicjeTypy/", propOrder = {
    "adresPol",
    "adresZagr"
})
@XmlSeeAlso({
    sprawozdania.rok2018.TPodmiotDowolny.AdresZamieszkaniaSiedziby.class,
    sprawozdania.rok2018.TOsobaFizyczna1 .AdresZamieszkania.class,
    sprawozdania.rok2018.TOsobaNiefizyczna.AdresSiedziby.class,
    sprawozdania.rok2018.TOsobaFizyczna2 .AdresZamieszkania.class,
    sprawozdania.rok2018.TOsobaNiefizycznaPelna.AdresSiedziby.class,
    sprawozdania.rok2018.TOsobaFizyczna.AdresZamieszkania.class,
    sprawozdania.rok2018.TPodmiotDowolnyPelny.AdresZamieszkaniaSiedziby.class,
    sprawozdania.rok2018.TOsobaFizycznaPelna.AdresZamieszkania.class
})
public class TAdres {
