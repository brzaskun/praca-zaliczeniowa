 ...
 */
@Embeddable
public class FakturadodelementyPK implements Serializable {
    ...
    public FakturadodelementyPK() {
    }

    public FakturadodelementyPK(String podatnik, String nazwaelementu) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof FakturadodelementyPK)) {
            return false;
        }
        FakturadodelementyPK other = (FakturadodelementyPK) object;
