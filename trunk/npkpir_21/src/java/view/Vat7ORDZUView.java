...
@ManagedBean
@RequestScoped
public class Vat7ORDZUView extends Vat7DKView implements Serializable{
     
    private String trescwyjasnienia;
    
    public void dodajzalacznikORDZAU() throws IOException{
        String rok = wpisView.getRokWpisu().toString();
        String mc = wpisView.getMiesiacWpisu();
        String podatnik = wpisView.getPodatnikWpisu();
        Deklaracjevat temp = deklaracjevatDAO.findDeklaracjeDowyslania(podatnik);
        Msg.msg("i","Wprowadzono tresc wyjasnienia "+trescwyjasnienia,"formX:msg");
        String zalacznik = new ORDZU(trescwyjasnienia).getOrdzu();
        String trescdeklaracji = temp.getDeklaracja();
        //pozbywamy sie koncowki </ns:Deklaracja>
        int lastIndexOf = trescdeklaracji.lastIndexOf("<podp:DaneAutoryzujace");
    ...
    public String getTrescwyjasnienia() {
        return trescwyjasnienia;
    }

    public void setTrescwyjasnienia(String trescwyjasnienia) {
        this.trescwyjasnienia = trescwyjasnienia;
    }
