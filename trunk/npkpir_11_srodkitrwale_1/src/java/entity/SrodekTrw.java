...
public class SrodekTrw implements Serializable {
    ...
    public byte[] getUmorzWyk() {
        return umorzWyk;
    }

    public void setUmorzWyk(byte[] umorzWyk) {
    ...
    public byte[] getUmorzPlan() {
        return umorzPlan;
    }

    public void setUmorzPlan(byte[] umorzPlan) {
