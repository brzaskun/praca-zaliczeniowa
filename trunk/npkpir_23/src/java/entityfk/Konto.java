...
@NamedQueries({
    ...
    @NamedQuery(name = "Konto.findByZwyklerozrachszczegolnePodatnik", query = "SELECT k FROM Konto k WHERE k.zwyklerozrachszczegolne = :zwyklerozrachszczegolne AND k.podatnik = :podatnik"),
