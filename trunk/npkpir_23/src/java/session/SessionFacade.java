...
//    }
    ...
    public List<Konto> findKonto860(WpisView wpisView) {
        return em.createNamedQuery("Konto.findByKonto860").setParameter("podatnik", wpisView.getPodatnikWpisu()).setParameter("rok", wpisView.getRokWpisu()).getResultList();
    }
