 ...
 *       &lt;sequence>
 *         &lt;element name="Naglowek" type="{http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2013/01/10/eD/VATZD/}TNaglowek_VAT-ZD"/>
 ...
 *                         &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *                           &lt;sequence>
 *                             &lt;element name="P_BB" type="{http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2011/06/21/eD/DefinicjeTypy/}TZnakowy"/>
 *                             &lt;element name="P_BC" type="{http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2011/06/21/eD/DefinicjeTypy/}TNrNIP"/>
 *                             &lt;element name="P_BD1" type="{http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2011/06/21/eD/DefinicjeTypy/}TZnakowy"/>
 *                             &lt;element name="P_BD2">
 *                               &lt;simpleType>
 *                                 &lt;restriction base="{http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2011/06/21/eD/DefinicjeTypy/}TData">
 *                                   &lt;minInclusive value="2011-09-01"/>
 *                                 &lt;/restriction>
 *                               &lt;/simpleType>
 *                             &lt;/element>
 *                             &lt;element name="P_BE">
 *                               &lt;simpleType>
 *                                 &lt;restriction base="{http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2011/06/21/eD/DefinicjeTypy/}TData">
 *                                   &lt;minInclusive value="2012-08-04"/>
 *                                 &lt;/restriction>
 *                               &lt;/simpleType>
 *                             &lt;/element>
 *                             &lt;element name="P_BF" type="{http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2011/06/21/eD/DefinicjeTypy/}TKwota2Nieujemna"/>
 *                             &lt;element name="P_BG" type="{http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2011/06/21/eD/DefinicjeTypy/}TKwota2Nieujemna"/>
 *                           &lt;/sequence>
 ...
 *                     &lt;/complexType>
 *                   &lt;/element>
 *                   &lt;element name="P_10" type="{http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2011/06/21/eD/DefinicjeTypy/}TKwotaCNieujemna"/>
 *                   &lt;element name="P_11" type="{http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2011/06/21/eD/DefinicjeTypy/}TKwotaCNieujemna"/>
 *                 &lt;/sequence>
 *               &lt;/restriction>
 *             &lt;/complexContent>
 *           &lt;/complexType>
...
@XmlRootElement(name = "Wniosek_VAT-ZD", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2013/01/10/eD/VATZD/")
public class WniosekVATZD {

    @XmlElement(name = "Naglowek", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2013/01/10/eD/VATZD/", required = true)
    protected TNaglowekVATZD naglowek;
    @XmlElement(name = "PozycjeSzczegolowe", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2013/01/10/eD/VATZD/", required = true)
    ...
    public static class PozycjeSzczegolowe {
        ...
        @XmlElement(name = "P_B", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2013/01/10/eD/VATZD/")
        protected List<WniosekVATZD.PozycjeSzczegolowe.PB> pb;
        @XmlElement(name = "P_10", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2013/01/10/eD/VATZD/", required = true)
        protected BigInteger p10;
        @XmlElement(name = "P_11", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2013/01/10/eD/VATZD/", required = true)
        ...
        public static class PB {
            ...
            @XmlElement(name = "P_BB", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2013/01/10/eD/VATZD/", required = true)
            @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
            protected String pbb;
            @XmlElement(name = "P_BC", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2013/01/10/eD/VATZD/", required = true)
            protected String pbc;
            @XmlElement(name = "P_BD1", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2013/01/10/eD/VATZD/", required = true)
            @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
            protected String pbd1;
            @XmlElement(name = "P_BD2", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2013/01/10/eD/VATZD/", required = true)
            protected XMLGregorianCalendar pbd2;
            @XmlElement(name = "P_BE", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2013/01/10/eD/VATZD/", required = true)
            protected XMLGregorianCalendar pbe;
            @XmlElement(name = "P_BF", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2013/01/10/eD/VATZD/", required = true)
            protected BigDecimal pbf;
            @XmlElement(name = "P_BG", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2013/01/10/eD/VATZD/", required = true)
