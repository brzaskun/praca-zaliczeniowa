...
var checkScreenSize = function (){
    ...
    var mobileThreshold = 767; // Zdefiniuj granicę dla urządzeń mobilnych
    if (width <= mobileThreshold) {
        document.getElementById('formmobile:hiddenField').value = 'mobile';
    } else {
        document.getElementById('formmobile:hiddenField').value = 'desktop';
    }
