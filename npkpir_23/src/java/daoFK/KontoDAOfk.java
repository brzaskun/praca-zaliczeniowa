...
//    }
    ...
    public List<Konto> findWszystkieKontaPodatnikaPobierzRelacje(Podatnik podatnik, String rok) {
        try {
            return kontoFacade.findKontoPodatnikRelacje(podatnik, rok);
        } catch (Exception e) {
            E.e(e);
            return null;
        }
    ...
    public List<Konto> findWszystkieKontaPodatnikaBezSlownikEdycja(Podatnik podatnik, String rok) {
        try {
            return Collections.synchronizedList(kontoFacade.findKontoPodatnikBezSlownikEdycja(podatnik, rok));
        } catch (Exception e) {
            E.e(e);
            return null;
        }
