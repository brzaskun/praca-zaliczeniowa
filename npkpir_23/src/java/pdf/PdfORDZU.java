...
public class PdfORDZU extends PdfVAT7{
    ...
    public static void drukujORDZU(Deklaracjevat dkl, Podatnik p) throws DocumentException, FileNotFoundException, IOException {
        ...
        PdfWriter writer = PdfWriter.getInstance(document, new FileOutputStream("C:/Users/Osito/Documents/NetBeansProjects/npkpir_23/build/web/vat/ordzu"+v.getPodatnik()+".pdf"));
        ...
        document.close();
        PdfReader reader = new PdfReader("C:/Users/Osito/Documents/NetBeansProjects/npkpir_23/build/web/vat/ordzu"+v.getPodatnik()+".pdf");
        PdfStamper pdfStamper = new PdfStamper(reader, new FileOutputStream("C:/Users/Osito/Documents/NetBeansProjects/npkpir_23/build/web/vat/ord-zu"+dkl.getPodatnik()+".pdf"));
...
//        writer.close();
        ...
        try {
            String[] files = {"C:/Users/Osito/Documents/NetBeansProjects/npkpir_23/build/web/vat/vat7-13GRZELCZYK.pdf","C:/Users/Osito/Documents/NetBeansProjects/npkpir_23/build/web/vat/ord-zufinal.pdf"};
            Document PDFCombineUsingJava = new Document();
            PdfCopy copy = new PdfCopy(PDFCombineUsingJava, new FileOutputStream("C:/Users/Osito/Documents/NetBeansProjects/npkpir_23/build/web/vat/CombinedPDFDocument.pdf"));
