...
public class PdfVATUEdekl {
    ...
    public static void drukujVATUE(PodatnikDAO podatnikDAO, DeklaracjavatUE d, WpisView wpisView) {
        ...
        dodajOpisWstepny(document, "Deklaracja VAT-UE firma: ", wpisView.getPodatnikObiekt(), d.getMiesiac(), d.getRok());
        dodajTabele(document, testobjects.getPozycje(d.getPozycje()),97,0);
...
//                document.add(new Paragraph(new Phrase("Urząd Skarbowy: "+d.getNazwaurzedu(), ft[1])));
//                document.add(new Paragraph(new Phrase("Kwota autoryzacyjna: "+d.getKwotaautoryzacja(), ft[1])));
