...
public class PdfPojazdy {
    ...
    public static void drukuj(List<PojazdyView.TabelaPojazdy> listapojazdow, WpisView wpisView, int rodzajdruku) {
        try {
            ...
            drukujcd(listapojazdow, wpisView, rodzajdruku);
    ...
    private static void drukujcd(List<PojazdyView.TabelaPojazdy> listapojazdow, WpisView wpisView, int rodzajdruku) throws DocumentException, FileNotFoundException, IOException {
        ...
        if (listapojazdow.size() > 0) {
            for (PojazdyView.TabelaPojazdy p : listapojazdow) {
    ...
    private static PdfPTable tablica(WpisView wpisView, PojazdyView.TabelaPojazdy l, int rodzajdruku) throws DocumentException, IOException {
        ...
        try {
            ...
            table.addCell(ustawfraze(l.getPojazd().getNazwapojazdu()+"/"+l.getPojazd().getNrrejestracyjny(), 1, 0));
            ...
            table.addCell(ustawfrazeSpanFont("Biuro Rachunkowe Taxman - zestawienie wydatków na pojazdy i maszyny", 6, 0, 5));
