...
public class ZusMailView implements Serializable {
    ...
    private static final String trescmaila = "<p> Szanowny Podatniku</p> <p> W niniejszym mailu znajdziesz naliczone kwoty zobowiązań z tytułu ZUS I PIT-4</p> "
            ...
            + " <td><span style='font-weight: bold'> Razem ZUS do przelania</span></td> <td style=\"text-align: right;\"> <span style=\"text-align: right;font-weight: bold\">%.2f</span></td> </tr> <tr> <td style=\"text-align: center;\"> 5</td><td>"
            + " <span style='font-weight: bold'>PIT-4</span></td> <td style=\"text-align: right;\"> <span style=\"text-align: right;font-weight: bold\">%.2f</span></td> </tr> <td style=\"text-align: center;\"> 5</td> <td>"
            + " <span style='font-weight: bold'>PIT-8AR</span></td> <td style=\"text-align: right;\"> <span style=\"text-align: right;font-weight: bold\">%.2f</span></td> </tr> </tbody> </table>"
