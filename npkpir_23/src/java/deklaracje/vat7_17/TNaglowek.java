...
public class TNaglowek {
    ...
    TNaglowek(Vatpoz pozycje) {
        this.kodFormularza = new TNaglowek.KodFormularza();
        this.wariantFormularza = (byte) 17;
        this.celZlozenia = new TNaglowek.CelZlozenia(pozycje);
        this.rok = Data.XMLGCinitRok(pozycje.getRok());
        this.miesiac = Byte.parseByte(pozycje.getMiesiac());
        this.kodUrzedu = pozycje.getKodurzedu();
    }
...
//            int year = newXMLGregorianCalendar.getMonth();
//            System.out.println("year "+Byte.parseByte("01"));
//        } catch (DatatypeConfigurationException ex) {
//            Logger.getLogger(TNaglowek.class.getName()).log(Level.SEVERE, null, ex);
//        }
//        }
    /**
    ...
    public static class CelZlozenia {
        ...
        public CelZlozenia(Vatpoz pozycje) {
            this.value = Byte.parseByte(pozycje.getCelzlozenia());
            this.poz = getPoz();
        }
    ...
    public static class KodFormularza {
        ...
        public KodFormularza() {
            this.kodSystemowy = getKodSystemowy();
            this.kodPodatku = getKodPodatku();
            this.rodzajZobowiazania = getKodPodatku();
            this.wersjaSchemy = getWersjaSchemy();
        }
