 ...
 *       &lt;sequence>
 *         &lt;element name="Naglowek" type="{http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2016/02/05/eD/ORDZU/}TNaglowek_ORD-ZU"/>
...
@XmlRootElement(name = "Zalacznik_ORD-ZU", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2016/02/05/eD/ORDZU/")
public class ZalacznikORDZU {

    @XmlElement(name = "Naglowek", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2016/02/05/eD/ORDZU/", required = true)
    protected TNaglowekORDZU naglowek;
    @XmlElement(name = "PozycjeSzczegolowe", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2016/02/05/eD/ORDZU/", required = true)
    ...
    public static class PozycjeSzczegolowe {
        ...
        @XmlElement(name = "P_13", namespace = "http://crd.gov.pl/xml/schematy/dziedzinowe/mf/2016/02/05/eD/ORDZU/", required = true)
