...
public class Vies2 {
    ...
    public static ViesVatRegistration  checkVat(javax.xml.ws.Holder<java.lang.String> countryCode, javax.xml.ws.Holder<java.lang.String> vatNumber) throws ViesVatServiceException {
        javax.xml.ws.Holder<javax.xml.datatype.XMLGregorianCalendar> requestDate = new Holder<>();
        javax.xml.ws.Holder<Boolean> valid = new Holder<>();
        javax.xml.ws.Holder<java.lang.String> name = new Holder<>();
        javax.xml.ws.Holder<java.lang.String> address = new Holder<>();
    ...
    public static void main(String[] args) {
        ...
        javax.xml.ws.Holder<java.lang.String> countryCode = new Holder<>("PL");
        javax.xml.ws.Holder<java.lang.String> vatNumber = new Holder<>("8511005008");
