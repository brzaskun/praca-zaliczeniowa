...
public class Beanjpk {
    ...
    private static String pobierzNIPkontrahenta(jpkfa.JPK.Faktura faktura) {
        String nip = "";
    ...
    private static Evewidencja pobierzewidencje(jpkfa.JPK.Faktura faktura, List<Evewidencja> evewidencje) {
    ...
    private static double obliczstawke(jpkfa.JPK.Faktura faktura) {
        double stawka = 23;
