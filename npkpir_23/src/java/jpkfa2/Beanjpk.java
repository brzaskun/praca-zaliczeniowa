...
public class Beanjpk {
    ...
    public static Dok generujdok(Object p, String waldok, List<Evewidencja> evewidencje, TabelanbpDAO tabelanbpDAO, Tabelanbp tabeladomyslna, List<Klienci> klienci, boolean wybierzosobyfizyczne, 
        ...
        jpkfa2.JPK.Faktura faktura = (jpkfa2.JPK.Faktura) p;
    ...
    private static Klienci pobierzkontrahenta(jpkfa2.JPK.Faktura faktura, String nrKontrahenta, List<Klienci> klienci, boolean wybierzosobyfizyczne, boolean deklaracjaniemiecka, KlienciDAO klDAO) {
    ...
    private static String pobierzNIPkontrahenta(jpkfa2.JPK.Faktura faktura) {
        String nip = "";
    ...
    private static Evewidencja pobierzewidencje(jpkfa2.JPK.Faktura faktura, List<Evewidencja> evewidencje) {
    ...
    private static double obliczstawke(jpkfa2.JPK.Faktura faktura) {
        double stawka = 23;
    ...
    public static Dokfk generujdokfk(Object p, String waldok, List<Evewidencja> evewidencje, TabelanbpDAO tabelanbpDAO, Tabelanbp tabeladomyslna, List<Klienci> klienci, boolean wybierzosobyfizyczne,
            ...
            KliencifkDAO kliencifkDAO, WpisView wpisView, KontoDAOfk kontoDAO, KontopozycjaZapisDAO kontopozycjaZapisDAO, UkladBRDAO ukladBRDAO, int numerkolejny, String kodwaluty) {
        jpkfa2.JPK.Faktura faktura = (jpkfa2.JPK.Faktura) p;
        Dokfk nd = null;
        try {
            HttpServletRequest request;
            ...
            if (juzjest != null) {
                ...
                ustawwiersze(nd, rodzajedok, faktura, tabeladomyslna, tabelanbpDAO, kliencifkDAO, wpisView, kontoDAO, kontopozycjaZapisDAO, ukladBRDAO, kodwaluty);
     ...
     private static void ustawwiersze(Dokfk nd, Rodzajedok rodzajedok,jpkfa2.JPK.Faktura faktura, Tabelanbp tabelanbppl, TabelanbpDAO tabelanbpDAO, KliencifkDAO kliencifkDAO, WpisView wpisView, KontoDAOfk kontoDAO, KontopozycjaZapisDAO kontopozycjaZapisDAO, UkladBRDAO ukladBRDAO, String kodwaluty) {
        ...
        nd.getListawierszy().add(przygotujwierszNettoSprzedaz(lpwiersza, nd, faktura, kontown, kontoma, tabelanbppl, tabelanbpDAO, kodwaluty));
        lpwiersza++;
        kontoma = rodzajedok.getKontovat();
        if (faktura.getVat()!=0.0) {
            nd.getListawierszy().add(przygotujwierszVATNalezny(lpwiersza, nd, faktura, kontown, kontoma, tabelanbppl, tabelanbpDAO, kodwaluty));
        }
    }
     ...
     private static void uzupelnijwiersz(Wiersz w, Dokfk nd, jpkfa2.JPK.Faktura faktura, Tabelanbp tabelanbppl, TabelanbpDAO tabelanbpDAO, String kodwaluty) {
        if (kodwaluty.equals("PLN")) {
            ...
            while (!znaleziono && (zabezpieczenie < 365)) {
                ...
                Tabelanbp tabelanbppobrana = tabelanbpDAO.findByDateWaluta(doprzekazania, kodwaluty);
