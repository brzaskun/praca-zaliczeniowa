...
public class SessionFacade<T> implements Serializable{
    ...
    public Konto findKontoNazwaPodatnik(String nazwaskrocona, String podatnik) {
        return (Konto) em.createNamedQuery("Konto.findByNazwaPodatnik").setParameter("nazwaskrocona", nazwaskrocona).setParameter("podatnik", podatnik).getSingleResult();
    }
    
    public List<Konto> findKontaNazwaPodatnik(String nazwaskrocona, String podatnik) {
        return em.createNamedQuery("Konto.findByNazwaPodatnik").setParameter("nazwaskrocona", nazwaskrocona).setParameter("podatnik", podatnik).getResultList();
    }
    
    public List<Konto> findKontaRozrachunkowe(String podatnik) {
        return em.createNamedQuery("Konto.findByRozrachunkowePodatnik").setParameter("zwyklerozrachszczegolne", "rozrachunkowe").setParameter("podatnik", podatnik).getResultList();
    }
    
    public List<Konto> findKontaRozrachunkoweWszystkie(String podatnik) {
        return em.createNamedQuery("Konto.findByRozrachunkiPodatnikWszystkie").setParameter("podatnik", podatnik).getResultList();
    }
    
    public List<Konto> findKontaVAT(String podatnik) {
        return em.createNamedQuery("Konto.findByVATPodatnik").setParameter("zwyklerozrachszczegolne", "vat").setParameter("podatnik", podatnik).getResultList();
    }
...
//    }
    ...
    public List<Konto> findKontaMaSlownik(String podatnik) {
        return em.createNamedQuery("Konto.findByMaSlownik").setParameter("maslownik", true).setParameter("podatnik", podatnik).getResultList();
    }
    ...
    public List<Kontopozycja> findKontaPodatnikUklad(UkladBR uklad) {
        return em.createNamedQuery("Kontopozycja.findByUklad").setParameter("uklad", uklad).getResultList();
    }
    ...
    public List<WierszBO> findBOLista0(String grupa, Podatnik podatnik) {
        return em.createNamedQuery("WierszBO.findByLista").setParameter("grupakonta", grupa).setParameter("podatnik", podatnik).getResultList();
    }
