 ...
 */
@Named
public class SaldoKontoNarastajacocomparator implements Comparator<SaldoKontoNarastajaco> {

    
    @Override
    public int compare(SaldoKontoNarastajaco o1, SaldoKontoNarastajaco o2) {
        try {
