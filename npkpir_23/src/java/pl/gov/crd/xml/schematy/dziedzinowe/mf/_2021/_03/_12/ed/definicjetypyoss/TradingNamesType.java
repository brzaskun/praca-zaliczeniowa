...
/**
 * <p>Java class for TradingNames_Type complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="TradingNames_Type">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="TradingName" maxOccurs="unbounded">
 *           &lt;simpleType>
...
@XmlType(name = "TradingNames_Type", propOrder = {
    "tradingName"
})
public class TradingNamesType {

    @XmlElement(name = "TradingName", required = true)
    @XmlJavaTypeAdapter(CollapsedStringAdapter.class)
    protected List<String> tradingName;
     ...
     * 
     */
    public List<String> getTradingName() {
        if (tradingName == null) {
            tradingName = new ArrayList<String>();
        }
