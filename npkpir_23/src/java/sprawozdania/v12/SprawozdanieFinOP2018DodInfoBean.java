 ...
 * @author Osito
 */
public class SprawozdanieFinOP2018DodInfoBean {

    public static JednostkaOp.DodatkoweInformacjeIObjasnieniaJednostkaInna generuj(SprFinKwotyInfDod sprFinKwotyInfDod) {
        JednostkaOp.DodatkoweInformacjeIObjasnieniaJednostkaInna p = new JednostkaOp.DodatkoweInformacjeIObjasnieniaJednostkaInna();
