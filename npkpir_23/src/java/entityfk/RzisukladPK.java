 ...
 */
@Embeddable
public class RzisukladPK implements Serializable {
    ...
    public RzisukladPK(String uklad, String podatnik, String rok) {
        this.uklad = uklad;
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof RzisukladPK)) {
            return false;
        }
        RzisukladPK other = (RzisukladPK) object;
