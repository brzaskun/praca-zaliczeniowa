...
@NamedQueries({
    ...
    @NamedQuery(name = "KontopozycjaBiezaca.findByPodatnik", query = "SELECT k FROM KontopozycjaBiezaca k WHERE k.ukladBR.podatnik = :podatnik"),
    @NamedQuery(name = "KontopozycjaBiezaca.findByPodatnikRok", query = "SELECT k FROM KontopozycjaBiezaca k WHERE k.ukladBR.podatnik = :podatnik AND k.ukladBR.rok = :rok"),
