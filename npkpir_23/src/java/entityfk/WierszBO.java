...
@NamedQueries({
    ...
    @NamedQuery(name = "WierszBO.findByDeletePodatnikRokBO", query = "DELETE FROM WierszBO w WHERE w.podatnik = :podatnik AND w.rok = :rok AND w.obrotyrozpoczecia = FALSE"),
    @NamedQuery(name = "WierszBO.findByDeletePodatnikRokMcBO", query = "DELETE FROM WierszBO w WHERE w.podatnik = :podatnik AND w.rok = :rok AND w.mc = :mc AND w.obrotyrozpoczecia = FALSE"),
    @NamedQuery(name = "WierszBO.findByDeletePodatnikRokObroty", query = "DELETE FROM WierszBO w WHERE w.podatnik = :podatnik AND w.rok = :rok AND w.obrotyrozpoczecia = TRUE"),
    @NamedQuery(name = "WierszBO.findByDeletePodatnikRokMcObroty", query = "DELETE FROM WierszBO w WHERE w.podatnik = :podatnik AND w.rok = :rok AND w.mc = :mc  AND w.obrotyrozpoczecia = TRUE"),
    @NamedQuery(name = "WierszBO.findByPodatnikRok", query = "SELECT w FROM WierszBO w WHERE w.podatnik = :podatnik AND w.rok = :rok"),
    @NamedQuery(name = "WierszBO.findByPodatnikRokListaBO", query = "SELECT w FROM WierszBO w WHERE w.podatnik = :podatnik AND w.rok = :rok AND w.otwarcielikwidacji = false AND w.obrotyrozpoczecia = FALSE"),
    @NamedQuery(name = "WierszBO.findByPodatnikRokListaLikwidacja", query = "SELECT w FROM WierszBO w WHERE w.podatnik = :podatnik AND w.rok = :rok AND w.otwarcielikwidacji = TRUE"),
    @NamedQuery(name = "WierszBO.findByPodatnikRokListaObroty", query = "SELECT w FROM WierszBO w WHERE w.podatnik = :podatnik AND w.rok = :rok AND w.mc = :mc AND w.obrotyrozpoczecia = TRUE"),
