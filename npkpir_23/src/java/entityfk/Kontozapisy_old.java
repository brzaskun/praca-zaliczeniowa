...
//    @NamedQuery(name = "Kontozapisy.findByWierszID", query = "SELECT k FROM Kontozapisy k WHERE k.wiersz.idwiersza = :wierszID"),
//    @NamedQuery(name = "Kontozapisy.findByKontoma", query = "SELECT k FROM Kontozapisy k WHERE k.kontoma = :kontoma")})
public class Kontozapisy_old implements Serializable {
...
//
//    public Kontozapisy_old() {
//    }
//
//    public Kontozapisy_old(Integer id) {
//        this.id = id;
//    }
//
//    public Kontozapisy_old(Integer id, String podatnik, String konto, Konto kontoob, Dokfk dokument, String opis, double kwotawn, String kontown, double kwotama, String kontoma) {
//        this.id = id;
...
//        if (!(object instanceof Kontozapisy_old)) {
//            return false;
//        }
//        Kontozapisy_old other = (Kontozapisy_old) object;
