...
//            if (p.getTypWiersza() == 1 || p.getTypWiersza() == 6) {
//                dodajwn16(p, opis, zapisynakontach, selected);
//            } else if (p.getTypWiersza() == 2 || p.getTypWiersza() == 7) {
//                dodajma27(p, opis, zapisynakontach, selected);
//            } else {
...
//        Msg.msg("i", "Zapisy na kontacg wygenerowane ");
    ...
    private static void dodajwn16(Wiersz p, String opis, List<Kontozapisy> zapisynakontach,Dokfk selected) {
        StronaWiersza wn = p.getStronaWn();
        Kontozapisy kontozapisy = new Kontozapisy();
        kontozapisy.setKontoobiekt(wn.getKonto());
        kontozapisy.setWiersz(p);
    ...
    private static void dodajma27(Wiersz p, String opis, List<Kontozapisy> zapisynakontach,Dokfk selected) {
        StronaWiersza ma = p.getStronaMa();
        Kontozapisy kontozapisy = new Kontozapisy();
        kontozapisy.setKontoobiekt(ma.getKonto());
        kontozapisy.setWiersz(p);
