    ...
    public void dodajnowapozycjeRZiS(String syntetycznaanalityczna) {
        if (syntetycznaanalityczna.equals("syntetyczna")) {
            ...
            if (((PozycjaRZiS) rootProjektRZiS.getFirstChild()).getNazwa().equals("Kliknij tutaj i dodaj pierwszą pozycję")) {
                ...
                int nrpprzedni = rootProjektRZiS.getChildCount() - 1;
                String poprzednialitera = ((PozycjaRZiS) ((TreeNode)rootProjektRZiS.getChildren().get(nrpprzedni)).getData()).getPozycjaSymbol();
...
//            StronaWierszaBean.pobraniegranica(stronywiersza, wpisView.getMiesiacNastepny());
    ...
    public void drukujBilansKonta() {
        PdfBilans.drukujBilansKonta(rootBilansAktywa, wpisView, "a", sumabilansowaaktywa, false);
        PdfBilans.drukujBilansKonta(rootBilansPasywa, wpisView, "b", sumabilansowapasywa, false);
    }
    
    public void drukujBilansKontaBez0() {
        PdfBilans.drukujBilansKonta(rootBilansAktywa, wpisView, "a", sumabilansowaaktywa, true);
        PdfBilans.drukujBilansKonta(rootBilansPasywa, wpisView, "b", sumabilansowapasywa, true);
    }
