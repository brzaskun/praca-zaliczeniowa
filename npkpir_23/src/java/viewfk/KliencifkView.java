...
public class KliencifkView implements Serializable {
    ...
    public void pobieraniekontaFKWpisCD() {
        ...
        if (wybranyklient!=null && wybranyklient.getNpelna()!=null && !wybranyklient.getNpelna().equals("dodaj klienta automatycznie") && !wybranyklient.getNpelna().equals("nowy klienta") && !wybranyklient.getNpelna().equals("nie znaleziono firmy w bazie Regon")) {
