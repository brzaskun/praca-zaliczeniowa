...
public class RewolucjaPodatnikView extends DAO implements Serializable {
    ...
    private void proc2() {
     ...
     public void proc5() {
        List<EVatDeklaracjaPlik> wiersze= sessionFacade.findAll(Cechazapisu.class);
        System.out.println("Pobralem");
        int i = 1;
     ...
     public void proc6() {
        List<EVatwpisDedra> wiersze= sessionFacade.findAll(Cechazapisu.class);
        System.out.println("Pobralem");
        int i = 1;
      ...
      public void proc7() {
        List<MiejscePrzychodow> wiersze= sessionFacade.findAll(Cechazapisu.class);
        System.out.println("Pobralem");
        int i = 1;
      ...
      public void proc8() {
        List<MiejsceKosztow> wiersze= sessionFacade.findAll(Cechazapisu.class);
        System.out.println("Pobralem");
        int i = 1;
      ...
      public void proc9() {
        List<Pojazdy> wiersze= sessionFacade.findAll(Cechazapisu.class);
        System.out.println("Pobralem");
        int i = 1;
      ...
      public void proc10() {
        List<SprawozdanieFinansowe> wiersze= sessionFacade.findAll(Cechazapisu.class);
        System.out.println("Pobralem");
        int i = 1;
      ...
      public void proc11() {
        List<WierszBO> wiersze= sessionFacade.findAll(Cechazapisu.class);
        System.out.println("Pobralem");
        int i = 1;
    ...
    public void proc12() {
        List<WynikFKRokMc> wiersze= sessionFacade.findAll(Cechazapisu.class);
        System.out.println("Pobralem");
        int i = 1;
